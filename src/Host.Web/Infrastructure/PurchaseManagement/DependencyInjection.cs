...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IApprovalCommandFactory>(sp =>
        {
            ...
            var approveFactory = new Application.Features.ApprovePurchaseRequest.ApprovalCommandFactory();
            var rejectFactory = new Application.Features.RejectPurchaseRequest.RejectCommandFactory();
