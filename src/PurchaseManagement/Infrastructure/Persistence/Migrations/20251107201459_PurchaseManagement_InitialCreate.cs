...
{
    /// <inheritdoc />
    public partial class PurchaseManagement_InitialCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "pm_OutboxMessages",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_pm_OutboxMessages", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_pm_OutboxMessages_ProcessedOnUtc",
                table: "pm_OutboxMessages",
