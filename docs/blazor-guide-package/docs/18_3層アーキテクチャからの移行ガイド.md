...
1. **レイヤー構成の確認**
   - [05_レイヤー構成と責務](07_レイヤー構成と責務.md)
   - 3層アーキテクチャとの対応を確認

2. **Repository/DbContextの確認**
   - [10_Infrastructure層の詳細設計](12_Infrastructure層の詳細設計.md)
...
1. **Dumb Component**
   - [07_UI層の詳細設計 - 7.1節](09_UI層の詳細設計.md#71-dumb-component純粋表示コンポーネント)
   - WPFのUserControlと同じ概念

2. **Smart Component**
   - [07_UI層の詳細設計 - 7.2節](09_UI層の詳細設計.md#72-smart-componentページコンポーネント)
   - WPFのWindowと同じ概念

3. **Store（状態管理）**
   - [07_UI層の詳細設計 - 7.4節](09_UI層の詳細設計.md#74-store状態管理)
   - ViewModelの状態管理部分を分離

4. **PageActions（UI手順）**
   - [07_UI層の詳細設計 - 7.3節](09_UI層の詳細設計.md#73-pageactionsui手順オーケストレーション)
...
3. **Pipeline Behaviorsの詳細**
   - [08_Application層の詳細設計](10_Application層の詳細設計.md)
...
1. **集約ルート・エンティティ・値オブジェクト**
   - [09_Domain層の詳細設計](11_Domain層の詳細設計.md)
   - 従来のEntityとの違い
...
1. **具体例で全体を理解**
   - [06_具体例_商品管理機能](08_具体例_商品管理機能.md)
...
- [06_具体例_商品管理機能](08_具体例_商品管理機能.md)で実装パターンを確認
- [07_UI層の詳細設計](09_UI層の詳細設計.md)でBlazor実装を学習
