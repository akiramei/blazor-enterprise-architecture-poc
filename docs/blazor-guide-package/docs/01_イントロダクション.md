...
1. [16_3層アーキテクチャからの移行ガイド](18_3層アーキテクチャからの移行ガイド.md) を読む
2. [05_レイヤー構成と責務](07_レイヤー構成と責務.md) で3層アーキテクチャとの対応を確認
...
1. [06_具体例_商品管理機能](08_具体例_商品管理機能.md) でCRUD全パターンを確認
...
**Step 1: 全体像の把握（30分）**
1. [02_アーキテクチャ概要](03_アーキテクチャ概要.md) で設計原則を理解
2. [04_全体アーキテクチャ図](06_全体アーキテクチャ図.md) でデータフローを確認

**Step 2: 各層の詳細を順番に学習（3時間）**
1. [07_UI層の詳細設計](09_UI層の詳細設計.md) - Component, Store, Actions
2. [08_Application層の詳細設計](10_Application層の詳細設計.md) - Command, Query, Handler
3. [09_Domain層の詳細設計](11_Domain層の詳細設計.md) - Entity, Value Object
4. [10_Infrastructure層の詳細設計](12_Infrastructure層の詳細設計.md) - Repository

**Step 3: 実装パターンを確認（1時間）**
1. [06_具体例_商品管理機能](08_具体例_商品管理機能.md)
...
2. [06_具体例_商品管理機能](08_具体例_商品管理機能.md) - コード例のテンプレート
3. [14_ベストプラクティス](16_ベストプラクティス.md) - よくある落とし穴
4. [13_テスト戦略](15_テスト戦略.md) - テストの書き方
