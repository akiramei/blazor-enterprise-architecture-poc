...
| パターン名 | 役割 | 実装場所 | 詳細 |
|-----------|-----|---------|------|
| **SessionProvider** | 認証状態・ユーザー情報のCascadingValue | `/Infrastructure/Providers/` | [09.5_状態管理の実践ガイド](09.5_状態管理の実践ガイド.md#1-sessionprovider認証状態管理) |
| **ThemeProvider** | ダークモード切り替え・システム設定連携 | `/Infrastructure/Providers/` | [09.5_状態管理の実践ガイド](09.5_状態管理の実践ガイド.md#2-themeproviderダークモード切り替え) |
| **PreferencesStore** | 言語・タイムゾーン・日付フォーマット | `/Infrastructure/Stores/` | [09.5_状態管理の実践ガイド](09.5_状態管理の実践ガイド.md#3-preferencesstoreユーザー設定管理) |
| **LayoutStore** | サイドバー・ナビゲーション状態 | `/Infrastructure/Stores/` | [09.5_状態管理の実践ガイド](09.5_状態管理の実践ガイド.md#4-layoutstoreレイアウト状態管理) |
| **NotificationStore** | トースト・モーダル管理 | `/Infrastructure/Stores/` | [09.5_状態管理の実践ガイド](09.5_状態管理の実践ガイド.md#5-notificationstore通知管理) |
...
| パターン名 | 役割 | 実装場所 | 詳細 |
|-----------|-----|---------|------|
| **ProductsStore** | 商品一覧の状態管理+I/O | `/Features/Products/Store/` | [09_UI層の詳細設計](09_UI層の詳細設計.md#74-store状態管理とio) |
| **ProductDetailStore** | 商品詳細の状態管理+I/O | `/Features/Products/Store/` | [09_UI層の詳細設計](09_UI層の詳細設計.md#74-store状態管理とio) |
| **ProductEditStore** | 商品編集の状態管理+I/O | `/Features/Products/Store/` | [09_UI層の詳細設計](09_UI層の詳細設計.md#74-store状態管理とio) |
| **ProductSearchStore** | 商品検索の状態管理+I/O | `/Features/Products/Store/` | [09_UI層の詳細設計](09_UI層の詳細設計.md#74-store状態管理とio) |
| **ProductListActions** | 商品一覧画面のUI手順 | `/Features/Products/Actions/` | [09_UI層の詳細設計](09_UI層の詳細設計.md#73-pageactionsui手順オーケストレーション) |
...
詳細は [09.5_状態管理の実践ガイド](09.5_状態管理の実践ガイド.md) を参照。
...
- [09_UI層の詳細設計](09_UI層の詳細設計.md) - Store, PageActions, Componentの詳細
- **[09.5_状態管理の実践ガイド](09.5_状態管理の実践ガイド.md) - システムレベル/ドメイン固有状態管理の使い分け** ⭐ 新規
