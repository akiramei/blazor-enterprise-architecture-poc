...
**Vertical Slice Architecture: 機能ごとに垂直分割（共通ドメインパターン）**
...
- **Domain/InfrastructureはProductCatalog/Sharedに集約**（全機能が同じProduct集約を使うため）
