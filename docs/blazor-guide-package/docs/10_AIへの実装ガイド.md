...
1. [03_パターンカタログ一覧](03_パターンカタログ一覧.md) で全パターンを把握
2. [04_基本パターン_参照系](04_基本パターン_参照系.md) でQuery実装を学習
3. [05_基本パターン_更新系](05_基本パターン_更新系.md) でCommand実装を学習
4. [06_Domain層パターン](06_Domain層パターン.md) でドメインモデルを学習
5. 実際のコードを読んで理解を深める
