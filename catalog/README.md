...
新規プロジェクトでこのカタログを使う場合は、**ローカルベンダリング**を推奨します。

### 推奨: AIと一緒にセットアップ

[README.md](../README.md#-カタログ利用ガイド) の「AIと一緒に始める」を参照してください。

### 詳細な手動セットアップ

[consumer-example/README.md](consumer-example/README.md) を参照してください。

### なぜローカルベンダリングか

| 観点 | GitHub参照 | ローカルベンダリング |
|------|-----------|-------------------|
| ネットワーク依存 | あり | **なし** |
